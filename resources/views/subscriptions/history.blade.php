 ...
 var table = $(function () {
    $("#example1").DataTable({
        ...
        columns: [
            ...
            {
            "render": function (data, type, full, meta) {
            	var status = full.status.id;
            	if(status == 1){
                return "<a href='/subscriptions/cancel/" + full.id + "' class='btn btn-danger'> Cancel <i class='fa-solid fa-ban'></i></a>";

            	}else if(status == 2){
            		return "<button class='btn btn-danger disabled'> Cancel <i class='fa-solid fa-ban'></i></button>";

            	}else if(status == 3){
            		return "<a class='btn btn-danger disabled'> Cancel <i class='fa-solid fa-ban'></i></a>";
            	}
            }
            }
